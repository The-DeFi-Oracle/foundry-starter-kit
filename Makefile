...
deploy-defi0m :; @forge script script/${contract}.s.sol:Deploy${contract} --rpc-url ${DEFI0M_RPC_URL}  --private-key ${PRIVATE_KEY} --broadcast --verify --etherscan-api-key ${ETHERSCAN_API_KEY}  -vvvv


# This is the private key of account from the mnemonic from the "make anvil" command
deploy-anvil :; @forge script script/${contract}.s.sol:Deploy${contract} --rpc-url ${DEFI0M_RPC_URL}  --private-key ${PRIVATE_KEY} --broadcast 
